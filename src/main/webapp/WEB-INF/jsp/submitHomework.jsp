...
%>
<div align="center">
    <h2>为作业<%=homework_number%>提交作业</h2>
    <form action="${pageContext.request.contextPath}/student/submitHomework" method="get">
        ...
        <table style="line-height: 40px">
            <tr>
                <th>作业标题：</th>
                <td><input type="text" name="homework_title" maxlength="20" size="40" style="font-family: 'Arial Black'"
                           required></input></td>
            </tr>
            <tr>
                <th>作业内容：</th>
